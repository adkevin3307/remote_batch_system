...
Session::Session(shared_ptr<boost::asio::io_context> io_context, int id, string host, string port, string filename)
...
void Session::connect_host(boost::asio::ip::tcp::resolver::iterator it)
{
